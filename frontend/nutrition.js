...
function renderBmiAssessment(bmi, category, color, mucTieu) {
    ...
    if (banner && bannerText) {
        if (mucTieu && mucTieu !== meta.suggestedGoal) {
            bannerText.innerHTML = `Với thể trạng <strong>${category}</strong>, mục tiêu phù hợp hơn là <strong>${meta.suggestedGoal}</strong> thay vì "${mucTieu}".`;
